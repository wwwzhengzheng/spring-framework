...
public class GenericApplicationContext extends AbstractApplicationContext implements BeanDefinitionRegistry {
	...
	public GenericApplicationContext() {
		...
		System.out.println("1-1-1:在GenericApplicationContext类中-执行构造函数GenericApplicationContext()，构造函数中执行new DefaultListableBeanFactory()方法...");
	}
	...
	public void registerBeanDefinition(String beanName, BeanDefinition beanDefinition)
		...
		System.out.println("X-2-2：GenericApplicationContext类中执行registerBeanDefinition方法，进行beanFactory.registerBeanDefinition bean注册--");
