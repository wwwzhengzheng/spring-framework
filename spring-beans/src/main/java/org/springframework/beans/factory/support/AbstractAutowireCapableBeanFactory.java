...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory
	...
	protected Object doCreateBean(String beanName, RootBeanDefinition mbd, @Nullable Object[] args)
		...
		if (mbd.isSingleton()) {
			...
			System.out.println("AbstractAutowireCapableBeanFactory.doCreateBean(创建bean三部曲)：1、实例化bean");
		}
		...
		try {
			// 第二步，填充属性
			System.out.println("AbstractAutowireCapableBeanFactory.doCreateBean(创建bean三部曲)：2、填充属性");
			populateBean(beanName, mbd, instanceWrapper);

			// 第三步，初始化
			System.out.println("AbstractAutowireCapableBeanFactory.doCreateBean(创建bean三部曲)：3、初始化");
